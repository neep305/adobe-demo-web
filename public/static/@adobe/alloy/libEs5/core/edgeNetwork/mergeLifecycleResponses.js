...
var _default = returnValues => {
  ...
  return (0, _index.assignConcatArrayValues)({}, ...lifecycleOnResponseReturnValues, ...consumerOnResponseReturnValues, ...lifecycleOnBeforeRequestReturnValues);
};
