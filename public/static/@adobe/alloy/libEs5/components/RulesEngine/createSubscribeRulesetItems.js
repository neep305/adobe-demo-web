...
var _default = ({
  ...
  const shouldAlwaysCollect = propositionEventType => [_propositionEventType.PropositionEventType.INTERACT, _propositionEventType.PropositionEventType.DISMISS].includes(propositionEventType);
  ...
  const subscriptions = (0, _createSubscription.default)();
